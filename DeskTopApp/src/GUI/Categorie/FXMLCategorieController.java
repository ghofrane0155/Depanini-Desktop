...
public class FXMLCategorieController implements Initializable {
    ...
    private void ChangeScene1(ActionEvent event) throws Exception {
        Parent AjouterParent = FXMLLoader.load(getClass().getResource("/GUI/Categorie/FXMLAjouterCategorie.fxml"));
...
//        Parent AjouterParent = FXMLLoader.load(getClass().getResource("/GUI/Categorie/FXMLModifierCategorie.fxml"));
//        Scene AjouterScene = new Scene(AjouterParent);
//
//        //this line gets the stage by force
//        Stage window = (Stage) ((Node) event.getSource()).getScene().getWindow();
...
//    }
    ...
    private void ChangeScene3(ActionEvent event) throws IOException {
        Parent AjouterParent = FXMLLoader.load(getClass().getResource("/GUI/Categorie/FXMLAfficherCategorie.fxml"));
        Scene AjouterScene = new Scene(AjouterParent);
    ...
    private void Modifier(ActionEvent event) throws IOException {
        Parent AjouterParent = FXMLLoader.load(getClass().getResource("/GUI/Categorie/ModifierCategories.fxml"));
        Scene AjouterScene = new Scene(AjouterParent);
