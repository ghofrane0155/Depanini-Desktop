...
public class FXMLAfficherController implements Initializable {
    java.sql.Connection connexion = MyDB.getInstance().getConx();
     String requete2 = "SELECT id_offre ,id_categorie, id_user ,prix_offre,description_offre,localisation_offre,nom_offre,image_offre,type_offre FROM  offres";
...
private OffresServices sc = new OffresServices();
  private Stage stage;
    ...
    @FXML
    private TableColumn<Offres, String> type_offre;
    @FXML
    private Button supp;
    @FXML
...
/**************refrech table*****************************************************/
    private void refreshTable(){    
        ...
        id_categorie.setCellValueFactory(new PropertyValueFactory<Offres,Integer>("id_categorie"));
        ...
        type_offre.setCellValueFactory(new PropertyValueFactory<Offres,String>("type_offre"));
